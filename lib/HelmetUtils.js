...
var updateTags = function updateTags(type, tags) {
    if (type === 'script') {
        var bbNodes = document && document.head.querySelectorAll("script[data-bb-script]");
        ...
        var links = document && document.head.getElementsByTagName('link') || [];
        var bbLinks = [];
        for (var _i2 = 0; _i2 < links.length; _i2++) {
            var href = links[_i2].getAttribute('href');
            for (var j = 0; j < tags.length; j++) {
                if (tags[j].href === href) {
                    bbLinks.push(links[_i2]);
                }
            }
        }
        if (bbLinks.length === tags.length) {
            ...
            for (var _i3 = 0; _i3 < bbLinks.length; _i3++) {
                if (bbLinks[_i3].parentNode) {
                    bbLinks[_i3].parentNode.removeChild(bbLinks[_i3]);
                }
            }
        }
    }
